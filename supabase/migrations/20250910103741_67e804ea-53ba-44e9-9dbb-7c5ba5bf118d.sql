-- Temporarily remove foreign key constraint to allow sample data
ALTER TABLE public.bus_trips DROP CONSTRAINT IF EXISTS bus_trips_organizer_id_fkey;

-- Insert sample bus trips for demonstration (without organizer constraint)
